...
import { Box, Button, Container, VStack, Heading, Textarea, Text, IconButton, useToast } from "@chakra-ui/react";
...
const Index = () => {
  ...
  return (
    <Container maxW={{ base: "100%", md: "container.md" }} py={5}>
      <VStack spacing={4}>
        <Heading as="h1" size="xl">
          Township Small Business Chatbot
        </Heading>
        <Box w="100%" p={4} borderWidth="1px" borderRadius="lg" overflowY="auto" maxHeight={{ base: "200px", md: "400px" }}>
